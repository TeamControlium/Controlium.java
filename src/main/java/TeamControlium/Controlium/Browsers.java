...
public class Browsers {
    ...
    public static BrowserType _getBrowserType() { return _TestBrowser; }
    ...
    public static boolean isChrome() { return _IsChrome; }
    ...
    public static void SetTestBrowser()
    {
        ...
        try {
          browser = TestData.getItem(String.class, ConfigBrowser[0], ConfigBrowser[1]);
        }
        catch (Exception e) {
            Logger.WriteLine(Logger.LogLevels.Error, String.format("Cannot get Browser type setting from test data: [%s],[%s]. Error: %s", ConfigBrowser[0], ConfigBrowser[1], e.getMessage()));
            throw new RuntimeException(String.format("Error getting setting [%s],[%s].", ConfigBrowser[0], ConfigBrowser[1]), e);
        }

        if (browser==null || browser.isEmpty()) {
            Logger.WriteLine(Logger.LogLevels.Error, String.format("Empty Browser type in test data: [%s],[%s].",ConfigBrowser[0], ConfigBrowser[1]));
            throw new RuntimeException(String.format("Empty Browser type in test data: [%s],[%s].",ConfigBrowser[0], ConfigBrowser[1]));
        }

        switch (browser.toLowerCase().replace(" ", "").replace("(","").replace(")", ""))
        {
            case "chrome66":
                _TestBrowser = BrowserType.Chrome66; _IsChrome = true; break;
            case "chrome67":
                _TestBrowser = BrowserType.Chrome67; _IsChrome = true; break;
            case "chrome68":
                _TestBrowser = BrowserType.Chrome68; _IsChrome = true; break;
            case "chrome69":
                _TestBrowser = BrowserType.Chrome69; _IsChrome = true; break;
            case "chrome70":
                _TestBrowser = BrowserType.Chrome70; _IsChrome = true; break;
            case "ie8":
            case "internetexplorer8":
                _TestBrowser = BrowserType.IE8; _IsInternetExplorer = true; break;
            case "ie9":
            case "internetexplorer9":
                _TestBrowser = BrowserType.IE9; _IsInternetExplorer = true; break;
            case "ie10":
            case "internetexplorer10":
                _TestBrowser = BrowserType.IE10; _IsInternetExplorer = true; break;
            case "ie11":
            case "internetexplorer11":
            case "ie":                                     // Default if no IE version given.
            case "internetexplorer":                       //
                _TestBrowser = BrowserType.IE11; _IsInternetExplorer = true; break;
            case "edge":
                _TestBrowser = BrowserType.Edge; _IsEdge = true; break;
            case "safari4":
                _TestBrowser = BrowserType.Safari4; _IsSafari = true; break;
            case "safari5":
            case "safari":                              // Default if no Safari version given as that is what is on Windows
                _TestBrowser = BrowserType.Safari5; _IsSafari = true; break;
            case "safari9":
                _TestBrowser = BrowserType.Safari9; _IsSafari = true; break;
            case "safari10":
                _TestBrowser = BrowserType.Safari10; _IsSafari = true; break;
            case "safari11":
                _TestBrowser = BrowserType.Safari11; _IsSafari = true; break;
            default:
