...
public class Devices {
    ...
    public static DeviceType _getDeviceType() { return _TestDevice; }
    ...
    private void SetTestDevice()
    {
        ...
        try {
            device = TestData.getItem(String.class, ConfigDevice[0], ConfigDevice[1]);
        }
        catch (Exception e) {
        ...
        switch (deviceNormalized)
        {
            case "xp":
            case "windowsxp":
                _TestDevice = DeviceType.WinXP; break;
            case "windows7":
            case "win7":
            case "w7":
                _TestDevice = DeviceType.Win7; break;
            case "windows8":
            case "win8":
            case "w8":
            case "windows8.0":
            ...
            case "win8_0":
            case "w8_0":
                _TestDevice = DeviceType.Win8; break;
            case "windows8.1":
            case "win8.1":
            case "w8.1":
            case "windows81":
            ...
            case "win8_1":
            case "w8_1":
                _TestDevice = DeviceType.Win8_1; break;
            case "windows10":
            case "win10":
            case "w10":
                _TestDevice = DeviceType.Win10; break;
            case "ipadpro":
            case "a1670":
                _TestDevice = DeviceType.iPadPro; break;
            case "ipad":
            case "ipad1":
            case "a1219":
            case "a1337":
                _TestDevice = DeviceType.iPad; break;
            case "ipad2":
            case "a1395":
            case "a1396":
            case "a1397":
                _TestDevice = DeviceType.iPad2; break;
            case "ipad3":
            case "ipad3rdgen":
            ...
            case "a1430":
            case "a1403":
                _TestDevice = DeviceType.iPad3; break;
            case "ipad4":
            case "ipad4thgen":
            ...
            case "a1459":
            case "a1460":
                _TestDevice = DeviceType.iPad4; break;
            case "ipad2017":
            case "a1822":
            case "a1823":
                _TestDevice = DeviceType.iPad2017; break;
            case "ipad2018":
                _TestDevice = DeviceType.iPad2018; break;
            case "ipadmini":
            case "ipadmini1":
            case "a1432":
            case "a1454":
            case "a1455":
                _TestDevice = DeviceType.iPadMini; break;
            case "ipadm2":
            case "ipadmini2":
            case "a1489":
            case "a1490":
            case "a1491":
                _TestDevice = DeviceType.iPadMini2; break;
            case "ipadm3":
            case "ipadmini3":
            case "a1599":
            case "a1600":
                _TestDevice = DeviceType.iPadMini3; break;
            case "ipadm4":
            case "ipadmini4":
            case "a1538":
            case "a1550":
                _TestDevice = DeviceType.iPadMini4; break;
            case "ipadair":
            case "ipadair1":
            case "a1474":
            case "a1475":
            case "a1476":
                _TestDevice = DeviceType.iPadAir; break;
            case "ipadair2":
            case "a1566":
            case "a1567":
                _TestDevice = DeviceType.iPadAir2; break;
            case "ios3":
            case "iphoneos3":
                _TestDevice = DeviceType.iOS3; break;
            case "ios4":
            case "iphoneos4":
                _TestDevice = DeviceType.iOS4; break;
            case "ios5":
            case "iphoneos5":
                _TestDevice = DeviceType.iOS5; break;
            case "ios6":
            case "iphoneos6":
                _TestDevice = DeviceType.iOS6; break;
            case "ios7":
            case "iphoneos7":
                _TestDevice = DeviceType.iOS7; break;
            case "ios9":
            case "iphoneos9":
                _TestDevice = DeviceType.iOS9; break;
            case "ios10":
            case "iphoneos10":
                _TestDevice = DeviceType.iOS10; break;
            case "ios11":
            case "iphoneos11":
                _TestDevice = DeviceType.iOS11; break;
            case "galaxy2":
            case "galaxys2":
            case "s2":
            case "sii":
            ...
            case "i9100g":
            case "i9105":
                _TestDevice = DeviceType.GalaxyS2; break;
            case "galaxy3":
            case "galaxys3":
            case "s3":
            case "siii":
            case "i9300":
            case "i9305":
                _TestDevice = DeviceType.GalaxyS3; break;
            case "galaxy4":
            case "galaxys4":
            case "s4":
            case "i9500":
            case "i9505":
                _TestDevice = DeviceType.GalaxyS4; break;
            case "galaxy5":
            case "galaxys5":
            case "s5":
            case "g900f":
            ...
            case "smg800f":
            case "smg900h":
                _TestDevice = DeviceType.GalaxyS5; break;
            case "galaxy6":
            case "galaxys6":
            case "s6":
                _TestDevice = DeviceType.GalaxyS6; break;
            case "galaxy7":
            case "galaxys7":
            case "s7":
                _TestDevice = DeviceType.GalaxyS7; break;
            case "galaxy8":
            case "galaxys8":
            case "s8":
            case "smg950x":
                _TestDevice = DeviceType.GalaxyS8; break;
            case "galaxy9":
            case "galaxys9":
            case "s9":
            case "smg960x":
                _TestDevice = DeviceType.GalaxyS9; break;
            default:
